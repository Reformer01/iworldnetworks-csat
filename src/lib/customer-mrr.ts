 ...
 */
export function getEffectiveMrr(customer: { mrrTotal: number | null; servicePlan: string | null }): number {
 ...
 */
export function getActiveEffectiveMrr(customer: { mrrTotal: number | null; servicePlan: string | null; lifecycle: string | null }): number {
