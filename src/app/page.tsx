  ...
  const heroContent: Record<Category, { title: React.ReactNode; sub: string; img: ImagePlaceholder }> = {
    Reliability: {
      title: (
        <>
          Stay{' '}
          <div className="relative h-[24px] w-[50px] md:h-[48px] md:w-[100px] rounded-full overflow-hidden inline-block mx-1 md:mx-2 border-2 border-white">
            <Image src={images.fiber.imageUrl} alt="fiber" fill sizes="100px" className="object-cover" />
          </div>{' '}
          Connected{' '}
          <div className="relative h-[24px] w-[50px] md:h-[48px] md:w-[100px] rounded-full overflow-hidden inline-block mx-1 md:mx-2 border-2 border-white">
            <Image src={images.customer.imageUrl} alt="customer" fill sizes="100px" className="object-cover" />
          </div>{' '}
          Always.
        </>
      ),
    ...
    Support: {
      title: (
        <>
          ...
          Answers{' '}
          <div className="relative h-[24px] w-[50px] md:h-[48px] md:w-[100px] rounded-full overflow-hidden inline-block mx-1 md:mx-2 border-2 border-white">
            <Image src={images.tech.imageUrl} alt="tech" fill sizes="100px" className="object-cover" />
          </div>{' '}
          Locally.
        </>
      ),
    ...
    Testimonials: {
      title: (
        <>
          ...
          Stories{' '}
          <div className="relative h-[24px] w-[50px] md:h-[48px] md:w-[100px] rounded-full overflow-hidden inline-block mx-1 md:mx-2 border-2 border-white">
            <Image src={images.workspace.imageUrl} alt="workspace" fill sizes="100px" className="object-cover" />
          </div>{' '}
          Shared.
        </>
      ),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const feedbackData = {
        ...
        ratings,
        customerName: formData.isAnonymous ? '' : formData.customerName,
      ...
      <main className="pt-24 md:pt-32 pb-24">
        <section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto grid grid-cols-1 lg:grid-cols-12 gap-gutter mb-24">
          <div className="lg:col-span-7">
            ...
            <p className="text-on-surface-variant text-sm md:text-body-lg mb-8 max-w-lg">{heroContent[activeCategory].sub}</p>
            <Button
              size="lg"
              className="bg-secondary text-white px-10 py-7 rounded-full font-bold hover:scale-105 transition-transform uppercase text-[12px] tracking-widest shadow-xl"
              ...
              <div className="flex flex-row lg:flex-col gap-2 overflow-x-auto pb-4 lg:pb-0 scrollbar-hide">
                {categories.map((cat) => (
                  <button
                    ...
                    className={cn(
                      'flex items-center gap-4 px-6 py-4 rounded-xl transition-all text-left whitespace-nowrap',
              ...
              <form onSubmit={handleSubmit} className="space-y-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-1">
                    ...
                    />
                    {errors.customerName && <p className="text-[10px] text-destructive font-semibold mt-1">{errors.customerName[0]}</p>}
                  </div>
                  <div className="space-y-1">
                    ...
                    />
                    {errors.customerEmail && <p className="text-[10px] text-destructive font-semibold mt-1">{errors.customerEmail[0]}</p>}
                  </div>
                </div>
                  ...
                  {activeCategory === 'Reliability' ? (
                    <>
                      <div className="space-y-1 flex flex-col justify-end">
                        ...
                        />
                        {errors.serviceDate && <p className="text-[10px] text-destructive font-semibold mt-1">{errors.serviceDate[0]}</p>}
                      </div>
                      <div className="space-y-1 flex flex-col justify-end">
                        <label className="font-mono text-[10px] uppercase text-on-surface-variant font-bold flex items-center gap-2 mb-2">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (errors.serviceTime)
                          setErrors((prev) => {
                            const copy = { ...prev };
                            delete copy.serviceTime;
                            return copy;
                          });
                      }}
                    />
                    {errors.serviceTime && <p className="text-[10px] text-destructive font-semibold mt-1">{errors.serviceTime[0]}</p>}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <optgroup label="Managed Services">
                        <option value="MSP-Basic">Managed IT — Basic</option>
                        <option value="MSP-Pro">Managed IT — Pro</option>
                        <option value="MSP-Enterprise">Managed IT — Enterprise</option>
                      </optgroup>
                    </select>
                    {errors.servicePlan && <p className="text-[10px] text-destructive font-semibold mt-1">{errors.servicePlan[0]}</p>}
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  {activeCategory === 'Reliability' && (
                    <>
                      ...
                      <div className="space-y-4 py-4">
                        <label className="font-mono text-[10px] uppercase text-on-surface-variant font-bold">
                          Describe Issues or Additional Feedback
                        </label>
                        <textarea
                          className="w-full bg-surface-container-low p-6 rounded-2xl border border-border min-h-[150px] outline-none resize-none font-bold placeholder:opacity-30"
                          placeholder="Please describe any latency, stability, or performance issues in detail..."
                  ...
                  {activeCategory === 'Support' && (
                    <>
                      <div className="space-y-4 py-4">
                        ...
                        <select
                          className="w-full bg-surface-container-low p-4 rounded-xl border border-border outline-none font-bold"
                      ...
                      {renderRatingGroup('professionalism', 'Professionalism', 'Was the agent courteous and professional?')}
                      {renderRatingGroup('clarity', 'Clarity', 'How clear was the communication?')}
                      {renderRatingGroup('responsiveness', 'Responsiveness', 'How quickly did the agent address your issue?')}
                      {renderRatingGroup('knowledge', 'Knowledge', 'Did the agent demonstrate expertise?')}
                      {renderRatingGroup('friendliness', 'Friendliness', 'Was the agent friendly and approachable?')}
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 py-6 border-b border-border/50">
                        <div className="max-w-md">
                          <h3 className="font-display text-lg text-primary font-bold">Response Time</h3>
                          <p className="text-on-surface-variant text-xs">How quickly did we respond to your issue?</p>
                        </div>
                        <div className="flex gap-2">
                          {[
                            { value: '5min', label: 'Within 5 min', color: 'bg-green-100 text-green-700 border-green-300' },
                            { value: '10min', label: 'Within 10 min', color: 'bg-amber-100 text-amber-700 border-amber-300' },
                            { value: '15min', label: 'Within 15 min', color: 'bg-red-100 text-red-700 border-red-300' },
                          ].map((opt) => (
                            <button
                              key={opt.value}
                              type="button"
                              onClick={() => handleRating('responseTime', opt.value)}
                              className={cn(
                                'px-4 py-2 rounded-full border text-[10px] font-bold font-mono uppercase transition-all',
                                ratings.responseTime === opt.value
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 py-6">
                        ...
                        <RadioGroup onValueChange={(v) => handleRating('fcr', v)} className="flex gap-8">
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="Yes" id="fcr-yes" />
                            <Label htmlFor="fcr-yes" className="font-bold">
                              Yes
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="No" id="fcr-no" />
                            <Label htmlFor="fcr-no" className="font-bold">
                              No
                            </Label>
                          </div>
                        </RadioGroup>
                      ...
                      <div className="space-y-4 py-4">
                        ...
                        <textarea
                          className="w-full bg-surface-container-low p-6 rounded-2xl border border-border min-h-[150px] outline-none resize-none font-bold placeholder:opacity-30"
                          placeholder="Tell us more about your support experience or describe your issue..."
                          value={formData.comment}
                          onChange={(e) => setFormData({ ...formData, comment: e.target.value })}
                        />
                      </div>
                  ...
                  {activeCategory === 'FieldSupport' && (
                    <>
                      ...
                      {renderRatingGroup(
                        'resolutionSpeed',
                        'Resolution Speed',
                        'How quickly was the physical repair or service restoration completed?',
                      )}
                      {renderRatingGroup(
                        'repairQuality',
                        'Repair Quality',
                        'Quality of cabling, equipment replacement, or physical restoration.',
                      )}
                      ...
                      <div className="space-y-4 py-4">
                        ...
                        <textarea
                          className="w-full bg-surface-container-low p-6 rounded-2xl border border-border min-h-[150px] outline-none resize-none font-bold placeholder:opacity-30"
                          placeholder="Describe the physical repair details or equipment issue and any feedback about the service visit..."
                          value={formData.comment}
                          onChange={(e) => setFormData({ ...formData, comment: e.target.value })}
                        />
                      </div>
                    ...
                    <>
                      <div className="space-y-6">
                        <div className="space-y-1">
                          ...
                          <select
                            className="w-full bg-transparent border-b border-border py-2 outline-none cursor-pointer font-bold"
                        ...
                        <div className="space-y-4">
                          ...
                          <textarea
                            className="w-full bg-surface-container-low p-6 rounded-2xl border border-border min-h-[150px] outline-none resize-none font-bold placeholder:opacity-30"
                            placeholder="Share your experience with I-World..."
                            value={formData.comment}
                            onChange={(e) => setFormData({ ...formData, comment: e.target.value })}
                          />
                        </div>
                            ...
                            {['Yes', 'No', 'Maybe'].map((opt) => (
                              <button
                                ...
                                className={cn(
                                  ...
                                  formData.spotlightInterview === opt
                  ...
                  {activeCategory === 'Installation' && (
                    <>
                      ...
                      <div className="space-y-4 py-4">
                        ...
                        <textarea
                          className="w-full bg-surface-container-low p-6 rounded-2xl border border-border min-h-[150px] outline-none resize-none font-bold placeholder:opacity-30"
                          placeholder="Tell us about the installation quality or orientation process..."
                          value={formData.comment}
                          onChange={(e) => setFormData({ ...formData, comment: e.target.value })}
                        />
                      </div>
                  ...
                  {activeCategory === 'Billing' && (
                    <>
                      ...
                      {renderRatingGroup(
                        ...
                        'Speed of internet restoration after billing or payment issues.',
                      )}
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 py-6 border-b border-border/50">
                        <div className="max-w-md">
                        ...
                        <RadioGroup onValueChange={(v) => handleRating('usedPortal', v)} className="flex gap-8">
                          <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="portal-yes" className="font-bold">
                              Yes
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="No" id="portal-no" />
                            <Label htmlFor="portal-no" className="font-bold">
                              No
                            </Label>
                          </div>
                        </RadioGroup>
                      ...
                      <div className="space-y-4 py-4">
                        ...
                        <textarea
                          className="w-full bg-surface-container-low p-6 rounded-2xl border border-border min-h-[150px] outline-none resize-none font-bold placeholder:opacity-30"
                          placeholder="Describe any billing issues or suggestions in detail..."
                          value={formData.comment}
                          onChange={(e) => setFormData({ ...formData, comment: e.target.value })}
                        />
                      </div>
                  ...
                  <div className="pt-8">
                    <Button
                      ...
                      className={cn(
                        'w-full md:w-auto px-12 py-7 rounded-full font-bold transition-all flex items-center justify-center gap-3 text-white uppercase text-[12px] tracking-widest shadow-xl',
                        isSubmitted ? 'bg-green-600' : 'bg-primary hover:scale-[1.02]',
                      )}
                    >
                      {isSubmitting ? (
      ...
      <footer className="bg-white border-t border-border py-12">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-12 gap-y-4">
            {validRegions.map((r) => (
              <a key={r} href="#" className="text-on-surface-variant hover:text-secondary font-mono text-[10px] uppercase font-bold">
                {r}
              </a>
            ))}
          </div>
