      ...
      <div className="max-w-container-max mx-auto">
        <header className="grid grid-cols-12 gap-gutter mb-16 items-end">
          <div className="col-span-12 md:col-span-7">
            <h2 className="font-display text-[32px] md:text-display-lg text-primary tracking-tight font-bold uppercase">
              Network Performance
            </h2>
                ...
                return (
                  ...
                  >
                    <span className="col-span-3 text-primary font-bold">
                      {mounted
                        ? `${new Date(f.timestamp ?? 0).toLocaleDateString()} ${new Date(f.timestamp ?? 0).toLocaleTimeString([], { hour12: false })}`
                        : '--/--'}
                    </span>
